...
//ttstr TVPGetSystemInitializeScript2()
//{
//	return ttstr(
////see KAGParser.tjs	
//TJS_W("\n"));
...
#if defined(TVP_TEXT_READ_ANSI_MBCS)
//	TVPScriptEngine->ExecScript( TVPGetSystemInitializeScript2() ); //Member "MenuItem" does not exist, //super.MenuItem(window, caption);
#endif	
#if USE_POLYFILL
//	TVPScriptEngine->ExecScript( TJS_N("Scripts.execStorage(\"system_polyfill/PolyfillInitialize.tjs\");"));
#endif
}
//---------------------------------------------------------------------------
...
//	buffer = ttstr(TJS_W("Scripts.execStorage(\"file://./home/wmt/work_krkrsdl2/krkrsdl2/spring_days_data/system_polyfill/PolyfillInitialize.tjs\"); // code injection\n")) + buffer;
	buffer = ttstr(TJS_W("Scripts.execStorage(System.exePath + \"system_polyfill/PolyfillInitialize.tjs\"); // code injection\n")) + buffer;
}
#endif
